 ...
 * Description: 【无需手动配置】 时间类型转换器
 */
public class DtToStrConvertor implements CustomConverter<SchemaBuilder, RelationalColumn> {
    private static final Logger log = LoggerFactory.getLogger(org.apache.doris.flink.tools.cdc.mysql.DateToStringConverter.class);
